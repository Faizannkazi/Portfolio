...
const ProjectTile = ({ project, classes, isDesktop }) => {
  ...
  // prepare image props: SVG imports don't support blurDataURL, only use
  // placeholder='blur' when blurDataURL is present on the import
  const imageProps =
    image && typeof image === "object" && image.blurDataURL
      ? {
          src: image,
          alt: name,
          placeholder: "blur",
